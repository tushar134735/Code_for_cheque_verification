function [Success, EPairs] = FuncErrorNCharPair(GTdir, ResultFile, File_Dictionary, k)
...
%         Lab = str2num(evalc('disp(name(L1+5:L2))'));
        ...
        fid = fopen(TXTName{1});
        tline = fgets(fid);
        DataGT = [DataGT; {tline blnk blnk blnk blnk blnk}];
        fclose(fid);
    end
